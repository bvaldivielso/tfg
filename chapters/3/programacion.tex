...
una función polimórfica en el la \textcolor{red}{???} variable de tipo \cod{a}
esté implementada
...
la izquierda es el de \cod{Const B}.\textcolor{red}{izquierda derecha?¿?¿?} Pero el de \cod{Const b}
